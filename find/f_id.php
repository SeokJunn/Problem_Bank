...
<section class="container">
		    <article class="half">
			        ...
			        <div class="tabs">
				            ...
				            <span class="tab signup"><a href="#signup">FIND PW</a></span>
			        </div>
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="find_chk.php" method="get" enctype="multipart/form-data">
                ...
                <form action="find_pw_chk.php" method="post" enctype="multipart/form-data">
						                    <input type="text" name="id" id="name" class="inpt" required="required" placeholder="Your id">
						                    <label for="id">Your id</label>
                                            <input type="emali" name="name" id="eamil" class="inpt" required="required" placeholder="Your email">
						                    <label for="email">Your email</label>
						                    <div class="submit-wrap">
							                        <input type="submit" value="Find PW" class="submit">
