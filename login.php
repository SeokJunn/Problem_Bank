        ...
        <article class="half">
            ...
            <div class="content">
                <div class="signin-cont cont">
                    <form action="login_action.php" method="get" enctype="multipart/form-data">
                        ...
                        <div class="submit-wrap">
                            ...
                            <a href="./find/f_id.php" class="more">Forgot your password?</a>
                        </div>
                    </form>
                </div>
                <div class="signup-cont cont">
                    <form action="join_action.php" method="get" enctype="multipart/form-data">
						                    <input type="text" name="id" id="id" class="inpt" required="required" placeholder="Your id">
						                    <label for="id">Your id</label>
